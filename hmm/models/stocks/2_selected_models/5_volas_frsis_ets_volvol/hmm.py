...
# Main execution
features = [
    'Volatility_Scaled',      # Continuous volatility measure
    'Fisher_RSI_Scaled',      # Normalized momentum
    'Enhanced_Trend',         # Directional trend strength
    'Vol_Volume'              # Volume-volatility interaction
]
state_names = [str(i) for i in range(5)]
